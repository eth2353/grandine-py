"""
Verify preset values match between YAML preset files and Rust source code.
...
PRESETS = {
    "gnosis": {
        "rust_file": "src/preset_gnosis.rs",
        "yaml_dir": "spec/presets/gnosis",
        "is_local": True,
    },
    "mainnet": {
        "rust_file": None,  # From upstream
        "yaml_dir": "spec/presets/mainnet",
        "is_local": False,
    },
    "minimal": {
        "rust_file": None,  # From upstream
        "yaml_dir": "spec/presets/minimal",
        "is_local": False,
    },
}
